        ...
        for result in results:
            dataWriter.writerow(
                [result['shortname'],
                 ...
                 result['foldername'],
                 result['itemId'],
                 'https://www.arcgis.com/home/item.html?id={}'.format(result['itemId']) if result['itemId'] else '',
                 result['serviceItemId'],
                 'https://www.arcgis.com/home/item.html?id={}'.format(result['serviceItemId']) if result['serviceItemId'] else '',
