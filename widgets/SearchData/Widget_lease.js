    ...
    var clazz = declare([BaseWidget, _WidgetsInTemplateMixin], {
      ...
      postCreate: function() {
        ...
        this._initSearch();
				...
				jimuUtils.combineRadioCheckBoxWithLabel(this.singleLease, this.singleLeaseLabel);
				jimuUtils.combineRadioCheckBoxWithLabel(this.multipleLeases, this.multipleLeasesLabel);
				jimuUtils.combineRadioCheckBoxWithLabel(this.lessee, this.lesseeLabel);
				jimuUtils.combineRadioCheckBoxWithLabel(this.lessor, this.lessorLabel);
				jimuUtils.combineRadioCheckBoxWithLabel(this.status, this.statusLabel);
				jimuUtils.combineRadioCheckBoxWithLabel(this.expirationDate, this.expirationDateLabel);
