...
define([
	...
	var clazz = declare([BaseWidget, _WidgetsInTemplateMixin], {
			...
			_qualifyURLs : function () {
				...
				this.config.abstractNumber.layer = this._convertToAbsURL(this.config.abstractNumber.layer);
				this.config.abstractName.layer = this._convertToAbsURL(this.config.abstractName.layer);
				this.config.blockNumber.layer = this._convertToAbsURL(this.config.blockNumber.layer);
				this.config.blockName.layer = this._convertToAbsURL(this.config.blockName.layer);
				this.config.surveyNumber.layer = this._convertToAbsURL(this.config.surveyNumber.layer);
				this.config.surveyName.layer = this._convertToAbsURL(this.config.surveyName.layer);
			},
